    ...
    void Update()
    {
        ...
        switch (Mode)
        {
            ...
            default:
                ...
                break;
            case 1:
                transform.localRotation = key1.localRotation;
                transform.localScale = key1.localScale;
                break;
            case 2:
                transform.localRotation = key2.localRotation;
                transform.localScale = key2.localScale;
                break;
            case 3:
                transform.localRotation = key3.localRotation;
                transform.localScale = key3.localScale;
                break;
            case 4:
                transform.localRotation = key4.localRotation;
                transform.localScale = key4.localScale;
                break;
            case 5:
                transform.localRotation = key5.localRotation;
                transform.localScale = key5.localScale;
                break;
            case 6:
                transform.localRotation = key6.localRotation;
                transform.localScale = key6.localScale;
                break;
        }
    }
}
